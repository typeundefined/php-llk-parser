...
public interface PhpParserTokenTypes {
	...
	int NUMBER = 151;
	int PARAMETERS = 152;
	int PARAMETER_DEF = 153;
	int ELIST = 154;
	int EXPR = 155;
	int FUNCTION_DEF = 156;
	int FUNCTION_BODY = 157;
	int FOR_INIT = 158;
	int FOR_CONDITION = 159;
	int FOR_ITERATOR = 160;
	int COLON_SLIST = 161;
	int LABEL = 162;
	int TYPE_CAST = 163;
	int CLASS_BODY = 164;
	...
	int FUNC_CALL = 167;
	int TYPE = 168;
	int VARIABLE_DEF = 169;
	int CASE_GROUP = 170;
	int SLIST = 171;
	int POST_INC = 172;
	int POST_DEC = 173;
	int ARRAY_DECLARATOR = 174;
	int ARRAY_INIT = 175;
	int ARRAY_ELEM = 176;
	int ARRAY_INDEX = 177;
	int UNARY_PLUS = 178;
	...
	int INDEX_OP = 182;
	int CHAR_ACCESS = 183;
	int INDIRECT_VAR_ID = 184;
	int CONST_ID = 185;
	int VAR_ID = 186;
	int BAND_ASS = 187;
	int BOR_ASS = 188;
	int LITERAL_null = 189;
}
